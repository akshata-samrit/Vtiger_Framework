...
public class TC_01CreateOpportunityTest extends BaseClass
{
	@Test(groups={"RegressionTest"})
	public void createOpportunityWithSalesStagedClosedLost() throws Throwable
	{
		...
		// Validation with sales Stage Closed Lost
		OpportunityInfoPage oip = new OpportunityInfoPage(driver);
		oip.verifyWithClosedLost();
		
		System.out.println("PASSED :: Opportunity Created with Sales Stage Closed Lost");
