...
public class TC_05CreateFilterTest extends BaseClass
{
	@Test(groups={"AdhocTest"})
	public void createFilterWithoutMandatoryFields() throws Throwable 
	{
		...
		// Create a New Filter Without Mandate Fields And Click On Save Button
		CreateFilterPage cfp = new CreateFilterPage(driver);
		cfp.createFilterWithoutMandateFields();
		cfp.getSaveButton().click();
		
		// Validation With Clicking On Ok Button Of Alert Pop Up
		cfp.verifyCreateFilterWithoutMandatoryFields();
